...
if __name__ == '__main__':
    root = r"/root/gast/data/PointDA_data/scannet/"
    save_root = r"/root/gast/data/PointDA_data/scannet_norm_curv"
    ...
    for f in fileName:
        ...
        for d in data:
            ...
            print("norm_included_angles.shape",norm_included_angles.shape)
